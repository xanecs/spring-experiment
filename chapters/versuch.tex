...
\begin{figure}[H]
\centering
\subfloat[Feder 1\label{fig:Feder1}]{\includegraphics[height=0.4\textheight]{img/Feder1.jpg}}
\qquad
\subfloat[Feder 2\label{fig:Feder1}]{\includegraphics[height=0.4\textheight]{img/Feder2.jpg}}
\qquad
\subfloat[Feder 3\label{fig:Feder1}]{\includegraphics[height=0.4\textheight]{img/Feder3.jpg}}
\qquad
\subfloat[Feder 4\label{fig:Feder1}]{\includegraphics[height=0.4\textheight]{img/Feder4.jpg}}
\qquad
\subfloat[Feder 5\label{fig:Feder1}]{\includegraphics[height=0.4\textheight]{img/Feder5.jpg}}
\qquad
\subfloat[Feder 6\label{fig:Feder1}]{\includegraphics[height=0.4\textheight]{img/Feder6.jpg}}
\qquad
\caption{Federn}
\label{fig:Federn}
\end{figure}
